...
int main(int argc, char** argv) {
	...
	Shader shaderCubeMap("cubemaps.vs", "cubemaps.fs");
	...
	Model terrainModel(localPath.string() + "/Resources/Terrain/terrain.obj");
	Model submarineModel(localPath.string() + "/Resources/Submarine/sub_obj.obj");
	...
	Skybox skybox;
	skybox.buildSkybox(shaderCubeMap, shaderSkybox);
